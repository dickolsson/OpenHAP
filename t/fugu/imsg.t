#!/usr/bin/env perl
# ex:ts=8 sw=4:
# Unit tests for Fugu::Imsg framing over a socketpair
...
subtest 'oversized payload is refused, not truncated' => sub {
	...
	my $max =
	    Fugu::Imsg::MAX_IMSGSIZE() - Fugu::Imsg::HEADER_SIZE();
...
subtest 'a zero timeout takes what arrived and returns' => sub {
	...
	my $whole =
	    Fugu::Imsg::_encode_header( 7,
		Fugu::Imsg::HEADER_SIZE() + 6, 0, $$ )
	    . 'abcdef';
