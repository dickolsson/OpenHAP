...
The JSON blob rides on L<Fugu::Store>. The two process IDs ride on
...
C<store> returns the L<Fugu::Store>. L<FuguVM::VM> gives it to the
...
L<Fugu::Pidfile>, L<Fugu::Store>, L<FuguVM::VM>
